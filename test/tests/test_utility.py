...
class ConstraintGenerationUtilitiesTest(TestCase):
    ...
    def test_create_constraints_for_cone_in_positive_quadrant(self):
        ...
        constraints = ConstraintGenerationUtilities.create_constraints_for_cone_in_positive_quadrant(
    ...
    def test_create_constraints_for_lower_bound(self):
        ...
        constraints = ConstraintGenerationUtilities.create_constraints_for_lower_bound_in_two_dimension(
